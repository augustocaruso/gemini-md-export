...
export const computeModalVirtualScrollRange = ({ clientHeight, scrollHeight, itemHeight, virtualItemCount = 0, }) => {
...
export const computeModalWheelScroll = ({ scrollTop, deltaY, ctrlKey = false, metaKey = false, ...metrics }) => {
