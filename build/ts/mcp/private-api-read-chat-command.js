...
const privateReadTimeoutMs = (value) => Math.max(5000, Math.min(120000, Number(value || 45000)));
export const buildPrivateApiReadChatCommand = (args = {}, client = null) => {
    ...
    return {
        args: {
            chatId: stringOrNull(args.chatId) || stringOrNull(args.url) || stringOrNull(client?.page?.chatId),
