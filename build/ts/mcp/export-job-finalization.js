...
export const normalizeFinishedExportJobStatus = (job, options = {}) => {
    ...
    const shouldCancel = fromStatus === 'cancel_requested' ||
...
export const markExportJobFinishedForReport = (job, options = {}) => {
