export const browserTransportMode = ({ bridgeHttpEnabled, nativeMessagingConfigured = false, nativeBrokerAvailable = null, contentScriptTransport = 'unknown', }) => {
    if (bridgeHttpEnabled === false &&
...
export const formatBrowserTransportMode = (status) => {
