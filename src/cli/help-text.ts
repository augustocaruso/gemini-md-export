export const outputModeHelp = (): string[] => [
  'Formatos de saida:',
...
export const exitCodeHelp = (): string[] => [
  'Exit codes:',
  '  0   sucesso completo',
...
export const commonOptionHelp = (): string[] => [
  'Opcoes comuns:',
...
export const jobOptionHelp = (): string[] => [
  'Opcoes de job:',
...
export const buildUsageHelp = ({
  version,
  outputModes = outputModeHelp(),
  exitCodes = exitCodeHelp(),
}: {
  version: string;
