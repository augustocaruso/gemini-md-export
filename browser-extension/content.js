...
(function () {
   ...
   * @returns {string}
   */
  const buildFrontmatter = ({ chatId, title, url, exportedAt, model }) => {
    const lines = ['---'];
  ...
  const SCRIPT_VERSION = '0.8.48';
  const BUILD_STAMP = '20260506-0536';
  ...
  const bootstrap = () => {
    ...
    log(`userscript carregado (v0.8.48 build 20260506-0536)`);
