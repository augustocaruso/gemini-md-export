...
export const readHostCssToken = (name, fallback = '', { documentRef = document } = {}) => {
...
export const buildHostPalette = ({ documentRef = document, isDark = false, } = {}) => {
...
export const buildDockHostPalette = (options = {}) => {
...
export const buildMenuHostPalette = (options = {}) => {
    const isDark = options.isDark === true;
    const palette = buildHostPalette(options);
    return {
...
export const applyCssVars = (element, vars) => {
