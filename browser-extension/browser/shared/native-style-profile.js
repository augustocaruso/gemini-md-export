...
export const GEMINI_LR26_NATIVE_STYLE_PROFILE = {
...
export const buildGeminiNativeStyleProfile = (_options = {}) => cloneNativeStyleProfile(GEMINI_LR26_NATIVE_STYLE_PROFILE);
export const applyGeminiNativeStyleVars = (element, profile) => {
